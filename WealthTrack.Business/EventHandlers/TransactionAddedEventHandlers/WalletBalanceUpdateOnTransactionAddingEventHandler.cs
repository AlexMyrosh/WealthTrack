...
{
    public class WalletBalanceUpdateOnTransactionAddingEventHandler(IUnitOfWork unitOfWork, IEventPublisher eventPublisher) : IEventHandler<TransactionAddedEvent>
    {
