...
public class OnboardingViewModel : BaseViewModel
{
    ...
    public OnboardingViewModel(IAuthService authService, IWalletService walletService, INavigationService navigationService, IDialogService dialogService)
    {
    ...
    {
        await Navigation.PushAsync(new LoginPage(_authService, _walletService, _navigationService, _dialogService));
    }
